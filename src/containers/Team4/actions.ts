...
export const onRequestDataResponseError = createAction<String>(HTTP_GET_FETCH_RESPONSE_ERROR);

export const onRequestDataFailed = createAction<String>(HTTP_GET_FETCH_FAILED);

export const showAllData = createAction<String>(SHOW_ALL_DATA);

export const showEvenData = createAction<String>(SHOW_EVEN_DATA);

export const showOddData = createAction<String>(SHOW_ODD_DATA);
